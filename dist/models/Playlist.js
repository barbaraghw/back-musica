...
const PlaylistSchema = new mongoose_1.Schema({
    ...
    songs: [{ type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Song' }], // Referencia al modelo Song
    userId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'User', required: true }, // Referencia al modelo User
